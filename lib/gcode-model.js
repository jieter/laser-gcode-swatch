...
function createObjectFromGCode(gcode) {
    ...
    var lastLine = {x: 0, y: 0, z: 0, f: 0, extruding: false};
    ...
    function getLineGroup(line) {
        ...
        var speed = Math.round(line.f / 1000);
        var grouptype = (line.laser_on ? 10000 : 0) + speed;
        var color = new THREE.Color(line.laser_on ? 0xffffff : 0xffff00);
    ...
    var pos = center.multiplyScalar(-scale);
...
export default createObjectFromGCode;
